...
<a href="{{ route('admin.articles') }}" class="list-group-item list-group-item-action">Add Articles</a>
<a href="{{ route('admin.departements') }}" class="list-group-item list-group-item-action">Add departements</a>
...
<a href="{{ route('admin.services') }}" class="list-group-item list-group-item-action">Add service</a>
    ...
    <button type="button" class="btn btn-primary ml-2" id="saveBtn" data-toggle="modal" data-target="#addDepartementModal">
        Add Departement
    </button>
</div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div id="formErrors" class="alert alert-danger" style="display: none;"></div>
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="addDepartementModalLabel">Add New Departement</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close" >
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <!-- Departement form goes here -->
                <form id="myForm"  action="{{ route('departements.store') }}" method="POST" enctype="multipart/form-data"  class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label for="épingler" class="form-check-label">Pin this article</label>
                    </div>
...
<script>
    ...
    function handleSaveButtonClick(e) {
        ...
        document.getElementById('submitFormBtn').addEventListener('click', function() {
            var name = document.getElementById('name_departement').value;
            var descriptionEditor = window.editor;
            var description = descriptionEditor.getData();
            var image = document.getElementById('image').files[0];
            var date = document.getElementById('date_departement').value;
