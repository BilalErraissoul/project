...
<a href="{{ route('admin.recherches') }}" class="list-group-item list-group-item-action">Add Recherche</a>
    ...
    <button type="button" class="btn btn-primary ml-2" id="saveBtn" data-toggle="modal" data-target="#addArticleModal">
        Add Article
    </button>
</div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div id="formErrors" class="alert alert-danger" style="display: none;"></div>
            ...
            <div class="modal-body">
                ...
                <form id="myForm"  action="{{ route('articles.store') }}" method="POST" enctype="multipart/form-data"  class="needs-validation" novalidate>
                    @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ClassicEditor
        .create( document.querySelector( '#description_article' ) )
        .then( editor => {
...
function handleSaveButtonClick(e) {
    ...
    document.getElementById('submitFormBtn').addEventListener('click', function() {
        ...
        var date = document.getElementById('date_article').value;
