...
<h1 class="logo h4 text-white bg-info p-2 rounded">UCD-FS</h1>
  ...
  <div class="row">
    ...
    <button type="button" class="btn btn-primary ml-2" id="saveBtn" data-toggle="modal" data-target="#addEventModal">
        Add Event
    </button>
</div>
    ...
    <div class="modal-dialog" role="document">
        ...
        <div id="formErrors" class="alert alert-danger" style="display: none;"></div>
            ...
            <div class="modal-body">
                ...
                <form id="myForm"  action="{{ route('events.store') }}" method="POST" enctype="multipart/form-data"  class="needs-validation" novalidate>
                    @csrf
                    ...
                    <div class="form-check mb-3">
                        ...
                        <label for="épingler" class="form-check-label">Pin this event</label>
                    </div>
