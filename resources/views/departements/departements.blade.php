...
<div class="col-lg-9 pt-0 ">
    ...
    <h1 class="mb-4"><i class="fas fa-calendar-alt"></i>DEPARTEMENTS</h1>
</div>
    ...
    <div class="article-item mb-4 p-3 mt-4" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ccc;">
        ...
        <div class="row align-items-center">
            <div class="col-md-5 position-relative overflow-hidden">
                <img src="/images/{{ $departement->image }}" class="img-fluid rounded"style="width: 100%; height: 150px; object-fit: cover;" alt="{{ $departement->name }}">
            ...
            <div class="col-md-7">
                ...
                <div class="description-container" style="max-height: 5em; overflow: hidden; position: relative;">
                    <p class="description-text" style="margin: 0;">{!! $departement->description !!}</p>
                    <span class="more-indicator" style="position: absolute; bottom: 0; right: 0;">...</span>
                </div>
                <div class="d-flex justify-content-between align-items-center" style="margin-top: 10px;">
                    <a href="{{ route('departements.show',['departement'=>$departement->id]) }}" class="text-primary">En savoir plus</a>
                    <p style="margin-bottom: 0;">{{ \Carbon\Carbon::parse($departement->created_at)->format('D M d Y H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
...
@foreach ($departementsNonEpingler as $departement)
<div class="article-item mb-4 p-3 mt-4" style="background-color: #ffffff; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); border: 1px solid #ccc;">
