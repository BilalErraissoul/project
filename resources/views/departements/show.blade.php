...
<div class="row">
    <div class="col-lg-12">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <img src="{{ asset('images/annonce.png') }}" alt="University Logo" class="img-fluid img-thumbnail" style="width: 100%; height: 280px; object-fit: cover;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-lg">
            <div class="card-header  text-white py-3"style="background-color:#001229">
                <h2 class="card-title mb-0">{{ $departement->name }}</h2>
                <p class="card-subtitle text-muted ">{{ $departement->date }}</p>
            </div>
            <div class="card-body">
                <p class="card-text text-justify">{!! $departement->description !!}</p>
                <img src="/images/{{ $departement->image }}" class="img-fluid mb-3 rounded" alt="{{ $departement->name }}">
            </div>
