...
<div class="container-fluid">
    <div class="row align-items-center" style="background-color: #f8f9fa;">
        ...
        <div class="col-lg-9">
            <img src="{{ asset('images/departements.png') }}" alt="Departement Image" class="img-fluid img-thumbnail" style="width: 100%; height: 270px; object-fit: cover;">
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-primary text-white py-3">
                    <h2 class="card-title mb-0">{{ $departement->name_departement }}</h2>
                    <p class="card-subtitle text-muted">{{ $departement->date_departement }}</p>
                </div>
                <div class="card-body">
                    <p class="card-text text-justify">{!! $departement->description_departement !!}</p>
                    <img src="{{ asset('images/' . $departement->image) }}" class="img-fluid mb-3 rounded" alt="{{ $departement->name_departement }}">
                </div>
