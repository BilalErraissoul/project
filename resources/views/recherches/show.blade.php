...
<div class="row">
    <div class="col-lg-12">
        <div class="row align-items-center">
            ...
            <div class="col-lg-9">
                <img src="{{ asset('images/recherche.png') }}" alt="University Logo" class="img-fluid img-thumbnail" style="width: 100%; height: 270px; object-fit: cover;">
            </div>
        </div>
    </div>
</div>
    ...
    <div class="col-lg-4">
        <div class="quick-access p-4 rounded bg-light shadow-sm">
            ...
            <div class="list-group">
                <a href="{{ route('events') }}" class="list-group-item list-group-item-action text-dark rounded-pill mb-2">events</a>
    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-lg">
            <div class="card-header bg-primary text-white py-3">
                <h2 class="card-title mb-0">{{ $recherche->name }}</h2>
                <p class="card-subtitle text-muted">{{ $recherche->date }}</p>
            </div>
            <div class="card-body">
                <p class="card-text text-justify">{!! $recherche->description !!}</p>
                <img src="/images/{{ $recherche->image }}" class="img-fluid mb-3 rounded" alt="{{ $recherche->name }}">
            </div>
            <div class="card-footer bg-light border-0 py-3">
                <a href="{{ route('recherches') }}" class="btn btn-secondary">Retour</a>
            </div>
        </div>
    </div>
</div>
