...
<div class="container col-10">
    ...
    <div class="col-lg-9">  
        <h1 class="mb-4" style="color: #003366; font-size: 36px; font-weight: bold;">LISTE DES ANNONCES</h1>
        @foreach ($annoncesEpingler as $annonce)
    <div class="annonce mb-4 p-3" style="background-color: #f8f9fa; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-8">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <p class="text-muted m-0" style="font-size: 18px;">{{ \Carbon\Carbon::parse($annonce->created_at)->format('D M d Y H:i') }}</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Afficher les annonces non épinglées -->
    @foreach ($annonces as $annonce)
    @if (!$annoncesEpingler->contains($annonce))
    <div class="annonce mb-4 p-3" style="background-color: #f8f9fa; border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        <div class="progress mb-2" style="height: 2px;">
            <div class="progress-bar" role="progressbar" style="width: 100%;" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
        </div>
