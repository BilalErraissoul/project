...
<div class="container-fluid">
    <div class="row align-items-center" style="background-color: #f8f9fa;">
        ...
        <div class="col-lg-9">
            <img src="{{ asset('images/annonce.png') }}" alt="Annonce Image" class="img-fluid img-thumbnail" style="width: 100%; height: 270px; object-fit: cover;">
        </div>
    </div>
        ...
        <div class="col-lg-8">
            <div class="card border-0 shadow-lg">
                <div class="card-header bg-primary text-white py-3">
                    <h2 class="card-title mb-0">{{ $annonce->name_annonce }}</h2>
                    <p class="card-subtitle text-muted">{{ $annonce->date_annonce }}</p>
                </div>
                <div class="card-body">
                    <p class="card-text text-justify">{!! $annonce->description_annonce !!}</p>
                    <img src="{{ asset('images/' . $annonce->image) }}" class="img-fluid mb-3 rounded" alt="{{ $annonce->name_annonce }}">
                </div>
