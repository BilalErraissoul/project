    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-lg">
            <div class="card-header  text-white py-3"style="background-color:#001229">
                <h2 class="card-title mb-0">{{ $annonce->name }}</h2>
                <p class="card-subtitle text-muted ">{{ $annonce->date }}</p>
            </div>
            <div class="card-body">
                <p class="card-text text-justify">{!! $annonce->description !!}</p>
                <img src="/images/{{ $annonce->image }}" class="img-fluid mb-3 rounded" alt="{{ $annonce->name }}">
            </div>
