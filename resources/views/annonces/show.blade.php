            ...
            <div class="col-lg-12">
                <div class="card border-0 shadow-lg">
                    <div class="card-header bg-primary text-white py-3">
                        <h2 class="card-title mb-0" style="font-family: 'Arial', sans-serif; font-size: 24px; font-weight: bold;">{{ $annonce->name_annonce }}</h2>
                        <p class="card-subtitle text-muted" style="font-family: 'Arial', sans-serif; font-size: 16px;">{{ $annonce->date_annonce }}</p>
                    </div>
                    <div class="card-body">
                        <p class="card-text" style="font-family: 'Arial', sans-serif; font-size: 18px;">{!! $annonce->description_annonce !!}</p>
                        <img src="/images/{{ $annonce->image }}" class="img-fluid mb-3 rounded" alt="{{ $annonce->name_annonce }}">
                    </div>
                    <div class="card-footer bg-light border-0 py-3">
                        <a href="{{ route('annonces') }}" class="btn btn-secondary">Retour</a>
                    </div>
                </div>
            </div>
        </div>
