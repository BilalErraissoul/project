...
<div class="row">
    <div class="col-lg-12">
        <div class="row align-items-center">
            <div class="col-lg-3  p-4 rounded mt-3 "style="background-color:#eceff8"
>
            ...
            <div class="col-lg-9">
                <img src="{{ asset('images/article.png') }}" alt="University Logo" class="img-fluid img-thumbnail" style="width: 100%; height: 280px; object-fit: cover;">
            </div>
        </div>
    </div>
</div>
<div class="row mt-4">
    <div class="col-lg-3  p-4 rounded "style="background-color:#f6f9ff">
    ...
    <div class="col-lg-9">
        <div class="card border-0 shadow-lg">
            <div class="card-header  text-white py-3"style="background-color:#001229">
                ...
                <p class="card-subtitle text-muted ">{{ $article->date }}</p>
            </div>
            <div class="card-body">
